    ...
    <div className="font-sans">
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Chat Body or Incomplete Profile Blocked State */}
          {!profileComplete ? (
            <div
              onPointerDown={(e) => e.stopPropagation()}
              className="flex-1 flex flex-col items-center justify-center p-6 text-center bg-slate-50/50 dark:bg-neutral-900/50 space-y-4"
            >
              <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center border border-indigo-500/20 shadow-xs">
                <Logo iconOnly className="w-7 h-7 object-contain" alt="getHack AI" />
              </div>
              ...
              <div className="space-y-1.5 max-w-xs">
                ...
                <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed font-medium">
                  Complete your profile first to use getHack AI Assistant.
                </p>
              </div>
              ...
              <button
                type="button"
                onClick={() => {
                  const targetRoute = user?.role === "organizer" ? "/organizer/profile" : "/profile";
                  navigate(targetRoute);
                }}
                className="w-full max-w-xs py-2.5 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white font-semibold text-xs transition-all shadow-md cursor-pointer flex items-center justify-center gap-2"
              >
