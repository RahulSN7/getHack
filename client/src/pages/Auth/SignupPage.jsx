// ---------------------------------------------------------------------------
// SignupPage.jsx — Production Authentication Registration Page
...
function SignupPage() {
  ...
  const handleSocialClick = (provider) => {
    setSocialNotice(`${provider} sign up is not configured in this demo environment.`);
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="text-center space-y-1 pt-1">
          ...
          >
            Join getHack to discover, connect, and collaborate
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          <label
            className={`block text-xs font-semibold ${
              isCardDark ? "text-neutral-200" : "text-neutral-800"
            }`}
          >
            How will you use getHack?
          </label>
                ...
                ${
                  role === "Participant"
                    ? isCardDark
                      ...
                      : "border-indigo-600 bg-indigo-50/60 text-neutral-900"
                    : isCardDark
