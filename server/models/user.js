...
userSchema.methods.toSafeUser = function () {
  ...
  return {
    ...
    profile: {
      ...
      role: typeof p.role === "string" ? p.role : (this.role === "organizer" ? "Organizer" : "Participant"),
      ...
      organizationName: typeof p.organizationName === "string" ? p.organizationName : (this.role === "organizer" ? this.name : ""),
      organizationType: typeof p.organizationType === "string" ? p.organizationType : "Student Club",
      organizationDescription: typeof p.organizationDescription === "string" ? p.organizationDescription : "",
      website: typeof p.website === "string" ? p.website : "",
      twitter: typeof p.twitter === "string" ? p.twitter : "",
      instagram: typeof p.instagram === "string" ? p.instagram : "",
      discord: typeof p.discord === "string" ? p.discord : "",
      contactNumber: typeof p.contactNumber === "string" ? p.contactNumber : "",
